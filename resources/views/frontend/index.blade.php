...
<div class="main-content">
    ...
    <div class="rs-services style1 pt-100 pb-84 md-pt-80 md-pb-64">
        <div class="container">
            <h2 align="center" ;><b>
                @lang('frontend.Distributoru_Oldugumuz_Markalar')
    ...
    <div id="rs-services" class="rs-services style1 modify pt-92 pb-84 md-pt-72 md-pb-64">
        <div class="container">
            <div class="sec-title text-center mb-47 md-mb-42">
                <h2 class="title mb-0">@lang('frontend.Urunler')</h2>
            </div>
                    ...
                    <div class="service-wrap">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9">
                                ...
                                <div class="content-part">
                                    <h5 class="title"><a href="{{$shop->link}}">{{$shop->name}}</a></h5>
                ...
                <div class="row">
                    <div class="col-lg-8 form-part">
                        <div class="sec-title mb-35 md-mb-30">
                             <h2 class="title mb-0">@lang('frontend.Bizimle_iletisime_Gecin')</h2>
                        </div>
