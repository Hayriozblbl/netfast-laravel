                 ...
                 <div class="col-lg-4 col-md-12 col-sm-12 footer-widget md-mb-39">
                     <div class="about-widget pr-15">
                         ...
                         <p class="desc" style="color: white;">
                            {{__('frontend.footer_text')}}
                            </p>

                     </div>
                 </div>
                 <div class="col-lg-4 col-md-12 col-sm-12 md-mb-32 footer-widget">
                     <h4 class="widget-title">@lang('frontend.iletisim_bilgilerimiz')
                     </h4>
         ...
         <div class="footer-bottom">
             <div class="row y-middle">
                 <div class="col-lg-6 col-md-8 sm-mb-21">
                     <div class="copyright">
                         <p>   @lang('frontend.copyright')

                           </p>
                     </div>

<div style="display:none"> <a href="https://themedya.com">The Medya Agency</a> </div>
                 </div>
