...
<h4>
Her Şey İnsana Değerle Başlar... </h4>
<p>
Netcom A.Ş yıllarca tecrübesiyle ve profesyonel hizmet kalitesiyle bilişim dünyasına sizlerle zenginlik katmaya devam edecektir.
</p>
 


<b>NETGRUP  topluluğundaki tüm iş fırsatları için  <a href="https://www.netgrup.com.tr/?cmd=IKBasvuru">Netgrup İK Başvuru Formu</a>  adresini ziyaret ediniz.</b> <br> <br>
              ...
              <div class="col-lg-4 md-mb-30">
                        <div class="info-item">
                            ...
                            <div class="content-part">
                                ...
                                <a href="tel:{{ GeneralSiteSettings('site_phone')}}">
                                    <h6 class="text-gray">{{ trans('frontend.phone') }}: <p style="direction:ltr;">{{ GeneralSiteSettings('site_phone')}}</p>
                                    </h6>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 md-mb-30">
                        <div class="info-item">
                            ...
                            <div class="content-part">
                                ...
                                <a href="mailto:{{ GeneralSiteSettings('site_email')}}">
                                    <h6 class="text-gray">{{ GeneralSiteSettings('site_email')}}</h6>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="contact-form-part">
                <div class="row md-col-padding">
                    ...
                    <div class="col-md-7 custom2 pl-0">
                        ...
                        <form id="contact-form" method="post" action="{{route('frontend.contact.send')}}">
                            {{ csrf_field() }}
